...
<header>
        ...
        <div class="container" id="category">
            <div class="row">
                <div class="col-sm-12 col-md-3 menu-box hover-hide">
...
<div class="container">
    <ul class="breadcrumb " itemscope itemtype="https://schema.org/BreadcrumbList">
        ...
        <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
            <link itemprop="item" href="delivery.html">
    ...
    <div class="row">
        ...
        <div class="container">
        <div class="row">
            <div id="content" class="col-sm-12"> <h1>Корзина покупок</h1>
                ...
                <tbody>                
                    <tr>
                        <td class="text-center"><a href="#">
                            <img src="img/tovaru/3554-47x47.jpg" alt="Перчатки ХБ 2ой облив (Ив) [10/300]" title="Перчатки ХБ 2ой облив (Ив) [10/300]" class="img-thumbnail"></a>
                        </td>
                        <td class="text-left">
                            <a href="#">Перчатки ХБ 2ой облив (Ив) [10/300]</a></td>
                <td class="text-left">3555</td>
                    <td class="text-left" style="width:207px">
                        <div class="input-group btn-block" style="display: flex;">
                            <button type="submit" data-id="tooltip2" title="" class="btn btn-danger minus" data-original-title="Уменьшить" style="border-radius: 4px 0 0 4px !important;height: 34px;text-align: center;display: flex;flex-direction: column;justify-content: center;align-items: center;"><i style="font-size: 24px; font-weight: 700; font-style: normal;">-</i></button>
                            <input type="text" name="quantity[2230]" value="2" size="1" class="form-control" style="width:106px; text-align: center;">
                            <span class="input-group-btn">
                            <button type="button" data-id="tooltip2" title="" class="btn btn-primary plus" onclick="" data-original-title="Добавить" style="height: 34px;text-align: center;display: flex;flex-direction: column;justify-content: center;align-items: center;">
                            <i style="font-size: 24px; font-style: normal;">+</i></button>
                            </span></div></td>
      ...
      <div class="buttons clearfix">
        <div class="pull-left"><a href="../index.php" class="btn btn-default">Продолжить покупки</a></div>
        <div class="pull-right"><a href="ajax-form" class="btn btn-primary">Оформление заказа</a></div>
      </div>
      </div>
    </div>
</div>
